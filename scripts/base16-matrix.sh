...
color04="00/ff/00" # Base 0D - Blue (Also green)
color05="00/ff/00" # Base 0E - Magenta (Also green)
color06="00/ff/00" # Base 0C - Cyan (Also green)
color07="00/ff/00" # Base 05 - White (Text)
color08="00/ff/00" # Base 03 - Bright Black (Also green)
